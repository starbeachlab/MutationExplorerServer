...
RELAXATION_FAILED = "Relaxation of initial structure failed. Check your input PDB. Potentially unknown HETATMs. Calpha only traces can not be handled. RaSP requires side-chains to be present."
